...
File Selection: User selects the file to be encrypted.

Key Exchange: Alice and Bob perform Diffie–Hellman exchange to derive a shared AES key.

Encryption: AES is used to encrypt the file data.

Signing: RSA signs the file hash (SHA-512) for authenticity.

Transmission: Data is sent through the channel, optionally intercepted by Eve.

Decryption: Bob decrypts using the shared AES key.

Verification: Bob verifies the RSA signature and hash to confirm integrity.
...
Cryptography Libraries	pycryptodome, hashlib, base64
Web Framework	Flask / Django
Frontend	HTML, CSS, JavaScript
Simulation	MATLAB (for Eve attack visualization)
Environment	Windows / Linux
Setup and Usage
1. Clone the Repository
git clone https://github.com/yourusername/RSA-File-Encryption.git
...
Generate RSA and DH keys

Test with or without Eve interference
